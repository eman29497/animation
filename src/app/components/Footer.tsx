...
export default function Footer(){
    return(
        <div className="bg-gray-100 py-10 mt-20 border-t border-gray-400">
            <div className=" max-w-6xl mx-auto flex fel-col md:flex-row justify-between items-center gap-6">
                <div className="text-xl font-bold text-purple-600">VibeFlow.</div>
                <div className="flex gap-8 text-sm font-medium text-purple-600">
